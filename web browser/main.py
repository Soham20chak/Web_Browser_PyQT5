...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        back_btn = QAction(QIcon(os.path.join('left-arrow.png')), "Back", self)
        back_btn.setStatusTip("Back to previous page")
        back_btn.triggered.connect(self.browser.back)
        navtb.addAction(back_btn)

        next_btn = QAction(QIcon(os.path.join('right-arrow.png')), "Forward", self)
        ...
        stop_btn = QAction(QIcon(os.path.join('cross.png')), "Stop", self)
